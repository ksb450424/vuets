...
import com.company.exception.UncheckException;
...
public class WebConfig extends AbstractAnnotationConfigDispatcherServletInitializer{
	...
	public SimpleMappingExceptionResolver getExceptionResolver() {
        ...
        mappings.setProperty("com.company.exception.DatabaseException", "/common/error/databaseError");
        mappings.setProperty("com.company.exception.SecurityException", "/common/error/securityError");
        mappings.setProperty("com.company.exception.BusinessException", "/common/error/businessError");
        mappings.setProperty("com.company.exception.AjaxException", "/common/error/ajaxError");
